...
namespace ConsoleProject
{
    public static class HandleTraderMessages
    {
        ...
        static string hostname = ConfigurationManager.AppSettings["TraderHostName"].ToString();
        static int port = 110;               
        static bool useSsl = false;              
        static string username = ConfigurationManager.AppSettings["TraderUserName"].ToString();
        static string password = ConfigurationManager.AppSettings["TraderPassword"].ToString();
