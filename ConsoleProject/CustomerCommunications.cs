    ...
    public class CustomerCommunications
    {
        ...
        public static void SendCustomerInfoEmailToStore(string hostStore, Customer cust)
        {
            try
            {
                ...
                if (hostStore == null)
                    mailHelper.sTo = ConfigurationManager.AppSettings["DefaultToEmailAddress"].ToString();
                else
                {
#if DEBUG
                ...
                mailHelper.sFrom = ConfigurationManager.AppSettings["DefaultFromEmailAddress"].ToString();  //todo
#endif
                }
...
#else
                mailHelper.sTo = ConfigurationManager.AppSettings["DefaultToEmailAddress"].ToString();
                mailHelper.sFrom = ConfigurationManager.AppSettings["DefaultFromEmailAddress"].ToString();
#endif
